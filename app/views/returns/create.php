...
<div class="card shadow-sm border-0 fade-in-up">
    <div class="card-header bg-white border-bottom py-3 d-flex justify-content-between align-items-center">
        <h5 class="mb-0 text-primary fw-bold">
            ...
            <?php echo $data['title']; ?> (<?php echo $data['type']; ?>)
        </h5>
    ...
    <div class="card-body p-4">
        <form
            action="<?php echo APP_URL; ?>/returns/<?php echo ($data['type'] == 'Credit Note') ? 'sales_return' : 'purchase_return'; ?>"
            method="post">
            <?php echo csrf_field(); ?>
            <div class="card bg-light border-0 p-3 mb-4">
                <div class="row g-3">
                    <div class="col-md-3">
                        <label class="form-label small fw-bold text-muted">Return No / Note #</label>
                        <input type="text" name="return_number" class="form-control fw-bold"
                            value="<?php echo $data['return_number']; ?>" readonly>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <label class="form-label small fw-bold text-muted">Original Invoice #</label>
                        <input type="text" name="original_invoice" class="form-control" placeholder="Ref No...">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label small fw-bold text-muted">
                            <?php echo ($data['type'] == 'Credit Note') ? 'Customer' : 'Vendor'; ?>
                        </label>
            ...
            <div class="card bg-light border-0 p-3 mb-4">
                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label small fw-bold text-muted">Ledger (
                            <?php echo ($data['type'] == 'Credit Note') ? 'Sales Return' : 'Purchase Return'; ?>)
                        </label>
                    ...
                    <div class="col-md-6">
                        <label class="form-label small fw-bold text-muted">Tax Ledger</label>
            ...
            <div class="row align-items-end">
                <div class="col-md-8">
                    <div class="card p-3 bg-light border-0">
                        <label class="form-label small fw-bold text-muted">Reason / Terms</label>
